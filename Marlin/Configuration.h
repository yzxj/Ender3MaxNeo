...
#define STRING_CONFIG_H_AUTHOR "(justinyeo, ender3maxneo_spritepro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Max Neo v4.2.2 Sprite (20230228v1.1)"
...
#define HEATER_0_MAXTEMP 300 // JY // sprite
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // JY Tuned Sprite at 200 deg
    #define DEFAULT_Kp  16.72
    #define DEFAULT_Ki   1.46
    #define DEFAULT_Kd  47.83
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Tuned at 55
  #define DEFAULT_bedKp 70.59 // JY Tuned
  #define DEFAULT_bedKi 10.76
  #define DEFAULT_bedKd 308.73
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.08, 80.17, 400, 424.9 }  // Ender Configs
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 1600 }  // Ender Configs // JY
 ...
 */
#define DEFAULT_ACCELERATION          800    // X, Y, Z and E acceleration for printing moves  // Ender Configs // JY
#define DEFAULT_RETRACT_ACCELERATION  1200    // E acceleration for retracts  // Ender Configs // JY
#define DEFAULT_TRAVEL_ACCELERATION   1200    // X, Y, Z acceleration for travel (non printing) moves  // Ender Configs // JY
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34, -40, -1.80 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)  // Manual mesh use the nozzle as probe
...
//#define Z_HOMING_HEIGHT  10      // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...  // MRiscoC Clearance over the bed
                                  // Be sure to have this much clearance over your Z_MAX_POS to prevent grinding.

//#define Z_AFTER_HOMING  5      // (mm) Height to move to after homing Z  // MRiscoC Clearance over the bed
...
#define X_BED_SIZE 308  // MRiscoC Max usable bed size
#define Y_BED_SIZE 300  // MRiscoC Max usable bed size

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 6  // MRiscoC Stock physical limit
#define Y_MIN_POS -6  // MRiscoC Stock physical limit
#define Z_MIN_POS 0
#define X_MAX_POS 324  // MRiscoC Stock physical limit
#define Y_MAX_POS 300  // MRiscoC Stock physical limit
#define Z_MAX_POS 320  // Ender Configs
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FIL_RUNOUT_ENABLED_DEFAULT false // Enable the sensor on startup. Override with M412 followed by M500. // DISABLE FOR NOW
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (8*60) }  // MRiscoC Homing speed-up // JY reduce Z feedrate
