 ...
 */
#define INPUT_SHAPING_X   // JY
#define INPUT_SHAPING_Y   // JY
  ...
  #define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters. // JY
#endif
...
#define LIN_ADVANCE
    ...
    #define ADVANCE_K { 0.02 }    // (mm) Compression length per 1mm/s extruder speed, per extruder // JY
  #else
    #define ADVANCE_K 0.02        // (mm) Compression length applying to all extruders // JY
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
  //#define LA_DEBUG              // Print debug information to serial during operation. Disable for production use.
  #define EXPERIMENTAL_SCURVE     // Allow S-Curve Acceleration to be used with LA. // JY
  #define ALLOW_LOW_EJERK       // Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends. // JY
...
#define FWRETRACT  // MRiscoC Enabled support for firmware based retract
  ...
  //#define FWRETRACT_AUTORETRACT             // Override slicer retractions  // MRiscoC use slicer retract
    ...
    #define MAX_AUTORETRACT             3 // (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH                0.8   // (mm) Default retract length (positive value)  // sprite
  #define RETRACT_LENGTH_SWAP           3   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE              40   // (mm/s) Default feedrate for retracting  // sprite // JY
  #define RETRACT_ZRAISE                0   // (mm) Default retract Z-raise  // sprite // JY
  #define RETRACT_RECOVER_LENGTH        0   // (mm) Default additional recover length (added to retract length on recover)
  #define RETRACT_RECOVER_LENGTH_SWAP   0   // (mm) Default additional swap recover length (added to retract length on recover from toolchange)
  #define RETRACT_RECOVER_FEEDRATE      40   // (mm/s) Default feedrate for recovering from retraction  // sprite // JY
